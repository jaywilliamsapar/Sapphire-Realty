    ...
    return (
        <div className='featured'>
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        <h2>Southcom Village, Dallas, TX</h2>
                        <p>House for Sale</p>
                    ...
                    <div className='info-grid'>
                        ...
                        <div>
                            <div className='info'>
                                <p className='bold'>Square Feet:</p><p>5,255</p>
                            </div>
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>$7,797/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className='container'>
                ...
                <div className='span-3 img-details order-6'>
                    <div className='top'>
                        <h2>Camp Crame, BGC Phil</h2>
                        <p className='bold'>House for Sale</p>
                        <p className='price'>$2,677,000</p>
                    </div>
                    <div className='info-grid'>
                        <div>
                        ...
                        <div>
                            ...
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>$12,497/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
